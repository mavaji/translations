\section[تفریح ناب]{تفریح ناب \protect\LTRfootnote{\lr{Pure Fun}} (راهنمایی \ref{hint:119}، جواب \ref{answer:101})}
\paragraph{}\label{prog:96}
برنامهٔ زیر، ایدهٔ ساده‌ای دارد. کلاس \lr{\texttt{list}}، لیستِ پیوندی را کنترل می‌کند و کلاس‌های مشتق‌شده، داده‌ها را کنترل می‌نمایند. ولی وقتی اجرا می‌شود، به بن‌بست می‌رسد. چرا؟
