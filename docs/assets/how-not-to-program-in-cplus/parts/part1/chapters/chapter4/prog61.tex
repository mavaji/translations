\section[بررسی یک واژه‌نامه به آهستگی]{بررسی یک واژه‌نامه به آهستگی \protect\LTRfootnote{\lr{Looking Through a Dictionary Slowly}} (راهنمایی \ref{hint:42}، جواب \ref{answer:74})}
\paragraph{}\label{prog:61}
من این برنامه را وقتی که دانشجوی سال سوم \lr{Caltech} بودم نوشتم (ابتدا به پاسکال نوشته شده بود). هجی من ضعیف بود برای همین نیاز به چیزی داشتم که با کمک آن بتوانم کلمات را در واژه‌نامه پیدا کنم.
