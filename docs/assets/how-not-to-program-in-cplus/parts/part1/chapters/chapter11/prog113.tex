\section[تسلیم]{تسلیم \protect\LTRfootnote{\lr{Flag Waving}} (راهنمایی \ref{hint:22}، جواب \ref{answer:52})}
\paragraph{}\label{prog:113}
این برنامه، قسمت کوچکی از درایورِ ترمینالِ یونیکس را در خود دارد. (درایورِ ترمینالِ یونیکس، تعداد زیادی پرچم\LTRfootnote{\lr{Flag}} دارد.)

وقتی این برنامه روی یک کامپیوتر \lr{Celerity C1000} قرار گرفت، مشکلات آغاز شدند. حدود یک بار در هفته، پرچم‌ها به طور اسرارآمیزی روشن یا خاموش می‌شدند. می‌توانید بگویید مشکل کجاست؟
